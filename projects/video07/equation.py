## path : cd Desktop/Math/GoldenMathMinds/projects/video07
...
class SimpleMathProblem(Scene):
    def construct(self):
       ...
       # Display a more complex equation with gradient color
        problem = MathTex(r"\int_0^{\pi} \sin(x) \, dx + 4!", font_size=48).set_color_by_gradient(PURPLE, BLUE, ORANGE)
